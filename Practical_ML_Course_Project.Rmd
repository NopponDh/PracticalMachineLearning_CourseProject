...
Our data consist of 19,622 observations of 160 variables

```{r}
dim(testingDataSet)
```

The testing data consist of 20 observation of 160 variables

### Clean the data

We'll remove the columns with missing value.
...
We now reduced the data into 60 variables.
